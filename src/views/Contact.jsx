      ...
      <main>
        <section className='container-main-contact'>
          <form ref={refForm} onSubmit={handleSubmit(onSubmit)}>
            <label>Name</label>
            <input type='text' placeholder='Tu nombre' required {...register('name')} />
            <label>Email</label>
            <input type='email' placeholder='tu@email.com' required {...register('email')} />
            <label>Message</label>
            <textarea placeholder='Tu mensaje' required {...register('message')} />
            {errors.email && <span>This field is required</span>}
            <button className='btn fill' type='submit'>Submit</button>
          </form>
          <div className="container-images-home-mobile">
            <div className='container-HalfElipse-contact'>
              <img
              ...
              <img
                className='img-half-elipse-contact'
                src={Elipse}
                alt=''
              />
